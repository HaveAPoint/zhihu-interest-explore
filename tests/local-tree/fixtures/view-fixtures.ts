...
import type { LocalTree, LocalNode, Candidate } from '@zhihu-explore/contracts';

// Deterministic valid RFC 4122 v4 UUID generator (strictly hex characters)
function makeUuid(hexPrefix: string, index: number): string {
...
export const treeAbcdefFixture: LocalTree = {
  id: treeAbcdefId,
...
export const longTitleTreeFixture: LocalTree = {
  id: treeLongTitleId,
...
export const multilineAnswerTreeFixture: LocalTree = {
  id: treeMultilineId,
...
export const duplicateWordsTreeFixture: LocalTree = {
...
export const sameHighlightForkTreeFixture: LocalTree = {
...
export const legacyTreeWithoutAnchorFixture: LocalTree = {
  id: treeLegacyId,
...
export const singleRootTreeFixture: LocalTree = {
  id: treeSingleRootId,
...
export const deep8TreeFixture: LocalTree = {
  id: treeDeep8Id,
...
export const wide8TreeFixture: LocalTree = {
  id: treeWide8Id,
...
export const hundredNodesTreeFixture: LocalTree = {
  id: treeHundredId,
...
export const allViewFixtures: LocalTree[] = [
  treeAbcdefFixture,
